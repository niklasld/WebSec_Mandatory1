<?php
    ...
    if(isset($_POST['username']) && isset($_POST['password'])){
        ...
        include_once($root.'/elavatedUser/config/euDbConn.php');
    ...
    function checkLogin($email, $pwd) {
        ...
        if(isset($user['LastLogin'])) {
            ...
            if($validate == "Success") {
                ...
                header("Location: ".$root."/wallviewAdmin"); 
            }
            else {
                echo "<br>";
                echo $validate;
    ...
    function updateFailedLogin($user, $currentTime) {
        ...
        //include dbconnection from anon souce.
        include_once($path.'/elavatedUser/config/GuestDbConn.php');
    ...
    function findUserByUserName($email) {
        $path = $_SERVER['DOCUMENT_ROOT'];
        //include dbconnection from anon souce.
        include_once($path.'/elavatedUser/config/euDbConn.php');
